...
public final class CommandInterceptorChain<R> {
     ...
     */
    public void sourcing(Sourcing joinPoint, StageWork work) {
     ...
     */
    public void sourcedEvent(SourcedEventInvocation joinPoint, StageWork work) {
     ...
     */
    public @Nullable R handler(CommandHandlerInvocation joinPoint, ValueContinuation<R> work) {
     ...
     * @param work the actual state-rebuilding handler invocation
     */
    public void publishedEvent(PublishedEventInvocation joinPoint, StageWork work) {
     ...
     */
    public Publish publish(Publish joinPoint, ValueContinuation<Publish> work) {
